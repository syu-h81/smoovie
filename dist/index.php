...
<body>
  <div class="wrapper">
      ...
      <div class="l-header__container">
        ...
        <nav class="l-header__nav">
          <ul class="l-header__nav__list">
            <a href="" class="l-header__nav__link">
          ...
          <div class="p-service__boxs">
            <div class="p-service__box">
              <div class="p-service__box__flex">
                ...
                <h3 class="p-service__box__heading">シンプルでお手頃な料金メニュー！</h3>
              </div>
              <div class="p-service__box__body">
                <div class="p-service__box__body__text">
                  <p>最安6万円から！動画の制作タイプと納品尺（秒／分）で選べるからわかりやすい！<br>※各種条件／オプション料金があります。</p>
                </div>
            ...
            <div class="p-service__box">
              <div class="p-service__box__flex">
                <div class="p-service__box__check"></div>
                <h3 class="p-service__box__heading">豊富なサンプル動画から制作イメージを探せる！</h3>
              </div>
              <div class="p-service__box__body">
                <div class="p-service__box__body__text">
            ...
            <div class="p-service__box">
              <div class="p-service__box__flex">
                <div class="p-service__box__check"></div>
                <h3 class="p-service__box__heading">プロのナレーター１名を無料で起用できる！</h3>
              </div>
              <div class="p-service__box__body">
                <div class="p-service__box__body__text">
            ...
            <div class="p-service__box">
              <div class="p-service__box__flex">
                <div class="p-service__box__check"></div>
                <h3 class="p-service__box__heading">納品スケジュールもスピーディ！</h3>
              </div>
              <div class="p-service__box__body">
                <div class="p-service__box__body__text">
    ...
    <!--======== p-plan ========-->
    <section class="p-plan l-section">
      <div class="p-plan__container l-container">
        <div class="p-plan__block">
          ...
          <div class="p-plan__btns">
            <div id="plan-A" class="p-plan__btn">
              <span>A</span>
            </div>
            <div id="plan-B" class="p-plan__btn">
              <span>B</span>
            </div>
            <div id="plan-C" class="p-plan__btn">
              <span>C</span>
            </div>
            <div id="plan-D" class="p-plan__btn">
              <span>D</span>
            </div>
            <div id="plan-E" class="p-plan__btn">
              <span>E</span>
            </div>
            <div id="plan-F" class="p-plan__btn">
              <span>F</span>
            </div>
            <div id="plan-G" class="p-plan__btn">
              <span>G</span>
            </div>
            <div id="plan-H" class="p-plan__btn">
              <span>H</span>
            </div>
          </div>
          <div class="p-plan__contents">
            <!-- === PLAN-A === -->
            <div class="p-plan__content p-plan__content__A">
              <div class="p-plan__content__border">PLAN <span>A</span>（撮影なし）</div>
              ...
              <div class="p-plan__content__sample">
                <div class="p-plan__content__sample__list">
                  <span>SAMPLE</span>
                  <div class="p-plan__content__sample__border"></div>
                  <a href="">サンプル一覧</a>
                </div>
                <div class="p-plan__content__sample__items">
                ...
                <div class="p-plan__content__price__flex">
                  <div class="p-plan__content__price__tables">
                    <div class="p-plan__content__price__tables__heading">
                      <span>PRICE</span>
                      <div class="p-plan__content__price__tables__border"></div>
                      <a href="#fee">料金表</a>
                    </div>
                    <div class="p-plan__content__price__tables__table">
            ...
            <!-- === PLAN-B === -->
            <div class="p-plan__content p-plan__content__B">
              <div class="p-plan__content__border">PLAN <span>B</span>（撮影なし）</div>
              <div class="p-plan__content__heading">
            ...
            <!-- === PLAN-C === -->
            <div class="p-plan__content p-plan__content__C">
              <div class="p-plan__content__border">PLAN <span>C</span>（撮影なし）</div>
              <div class="p-plan__content__heading">
            ...
            <!-- === PLAN-D === -->
            <div class="p-plan__content p-plan__content__A">
              <div class="p-plan__content__border">PLAN <span>D</span>（撮影なし）</div>
              <div class="p-plan__content__heading">
            ...
            <!-- === PLAN-E === -->
            <div class="p-plan__content p-plan__content__A">
              <div class="p-plan__content__border">PLAN <span>E</span>（撮影なし）</div>
              <div class="p-plan__content__heading">
              ...
              <div class="p-plan__content__price">
                ...
                <div class="p-plan__content__price__supplyment">
                  <p>
                    ※金額は、すべて税別です。ご依頼の内容により変動する場合があります。　※時間（分）は、<span class="u-color-primary">3DCG部分１素材あたりになります。</span>
            ...
            <!-- === PLAN-F === -->
            <div class="p-plan__content p-plan__content__F">
              <div class="p-plan__content__border">PLAN <span>F</span>（撮影あり）</div>
              <div class="p-plan__content__heading">
            ...
            <!-- === PLAN-G === -->
            <div class="p-plan__content p-plan__content__F">
              <div class="p-plan__content__border">PLAN <span>G</span>（撮影あり）</div>
              <div class="p-plan__content__heading">
              ...
              <div class="p-plan__content__price">
                ...
                <div class="p-plan__content__price__supplyment">
                  <p>
                    ※金額は、すべて税別です。ご依頼の内容により変動する場合があります。　※時間（分）は、<span class="u-color-primary-2">制作動画の納品尺</span>です。 <span class="u-color-primary-2">撮影に要する時間ではありません。</span><br>
                    ※撮影に伴う出張経費やメイク・小道具・スタジオ手配等は別途　　※撮影日数が２日以上、または宿泊が必要な遠方の場合は、別途お見積もり<br>
                    ※追加オプションは料金表を参照
                  </p>
                </div>
            ...
            <!-- === PLAN-H === -->
            <div class="p-plan__content p-plan__content__F">
              <div class="p-plan__content__border">PLAN <span>H</span>（撮影あり）</div>
              <div class="p-plan__content__heading">
                  ...
                  <div class="p-plan__content__detail__imagenation">
                    ...
                    <div class="p-plan__content__detail__imagenation__body">
                      ...
                      <div class="p-plan__content__detail__imagenation__alignment__boxs">
                        ...
                        <div class="p-plan__content__detail__imagenation__alignment__box">プロモーショn会社</div>
    ...
    <section class="p-feel-section">
      <div class="p-fee__container l-container">
        <div class="p-fee__block">
          ...
          <!-- == オプション料金のタイトル == -->
          <div id="option-heading" class="p-fee__heading c-heading-box">
            <div class="p-fee__heading__logo">
          ...
          <div class="p-fee__btns">
            <button id="fee-btn" class="p-fee__btn">料金プラン</button>
            <button id="option-fee-btn" class="p-fee__btn">オプションプラン</button>
          </div>
          <!-- == 料金プランのコンテンツ == -->
          <div id="fee-content" class="p-fee__content">
            <div class="p-fee__content__edit__block">
              <div class="p-fee__content__edit__ele__1 p-fee__content__ele__1">
                ...
                <div class="p-fee__content__edit__length p-fee-content__length">
                  <div class="p-fee__content__edit__length__heading p-fee-content__length__heading">
                    <span>完成動画の総尺</span>
                  </div>
                  <div class="p-fee__content__edit__length__times p-fee-content__length__times">
                    <div class="p-fee__content__edit__length__time p-fee-content__length__time">15秒まで</div>
                    <div class="p-fee__content__edit__length__time p-fee-content__length__time">30秒まで</div>
                    <div class="p-fee__content__edit__length__time p-fee-content__length__time">1分まで</div>
                    <div class="p-fee__content__edit__length__time p-fee-content__length__time">以降1分単位</div>
                  </div>
                </div>
              </div>
              <div class="p-fee__content__edit__ele__A">
              ...
              <div class="p-fee__content__edit__ele__flex">
                <div class="p-fee__content__edit__ele__BC">
                  <div class="p-fee__content__edit__ele__B">
                    <div class="p-fee__content__edit__logo">
                      <img src="assets/images/plan_B_logo.png" alt="planA">
                    </div>
                    <div class="p-fee__content__edit__text">
                      <span>ご提供の画像・動画に演出を加えて編集</span>
                    </div>
                    <div class="p-fee__content__edit__amounts">
                      <div class="p-fee__content__edit__amount"><span>15</span>万円</div>
                      <div class="p-fee__content__edit__amount"><span>20</span>万円</div>
                    </div>
                  </div>
                  <div class="p-fee__content__edit__ele__C">
                    <div class="p-fee__content__edit__logo">
                      <img src="assets/images/plan_C_logo.png" alt="planA">
                    </div>
                    <div class="p-fee__content__edit__text">
                      <span>ご提供の画像・動画に演出を加えて編集</span>
                    </div>
                    <div class="p-fee__content__edit__amounts">
                      <div class="p-fee__content__edit__amount"><span>20</span>万円</div>
                      <div class="p-fee__content__edit__amount"><span>25</span>万円</div>
                      <div class="p-fee__content__edit__amount"><span>30</span>万円</div>
                    </div>
                  </div>
                </div>
                <div class="p-fee__content__edit__ele__BC__last_amounts">
                  <div class="p-fee__content__edit__ele__BC__last_amount">＋<span>5</span>万円</div>
                </div>
              </div>
              <div class="p-fee__content__edit__ele__D">
                <div class="p-fee__content__edit__logo">
                  <img src="assets/images/plan_D_logo.png" alt="planA">
                </div>
                <div class="p-fee__content__edit__text">
            ...
            <div class="p-fee__content__3D__block">
              <div class="p-fee__content__3D__ele_1 p-fee__content__ele__1">
                <div class="p-fee__content__3D__heading p-fee__content__heading">
                  <strong>3DCG</strong>
                  <span>※追加オプションは料金表をご参照ください</span>
                </div>
                <div class="p-fee__content__3D__length p-fee-content__length">
                  <div class="p-fee__content__3D__length__heading p-fee-content__length__heading">
                    <span>1素材あたりの総尺</span>
                  </div>
                  <div class="p-fee__content__3D__length__times p-fee-content__length__times">
                    <div class="p-fee__content__3D__length__time p-fee-content__length__time">15秒まで</div>
                    <div class="p-fee__content__3D__length__time p-fee-content__length__time">30秒まで</div>
                    <div class="p-fee__content__3D__length__time p-fee-content__length__time">1分まで</div>
                    <div class="p-fee__content__3D__length__time p-fee-content__length__time">以降30秒単位</div>
                  </div>
                </div>
              </div>
              <div class="p-fee__content__edit__ele__E">
                <div class="p-fee__content__edit__logo">
                  <img src="assets/images/plan_E_logo.png" alt="planA">
                </div>
                <div class="p-fee__content__edit__text">
                ...
                <div class="p-fee__content__edit__amounts">
                  <div class="p-fee__content__edit__amount"><span>25</span>万円</div>
                  <div class="p-fee__content__edit__amount"><span>35</span>万円</div>
                  <div class="p-fee__content__edit__amount"><span>50</span>万円</div>
                  <div class="p-fee__content__edit__amount">＋<span>15</span>万円</div>
                </div>
              </div>
            </div>
            <div class="p-fee__content__photograph__block">
              <div class="p-fee__content__photograph__ele_1">
                ...
                <div class="p-fee__content__edit__length p-fee-content__length">
                  ...
                  <div class="p-fee__content__edit__length__times p-fee-content__length__times">
                    <div class="p-fee__content__edit__length__time p-fee-content__length__time">5秒まで</div>
                    <div class="p-fee__content__edit__length__time p-fee-content__length__time">10秒まで</div>
                    <div class="p-fee__content__edit__length__time p-fee-content__length__time">15秒まで</div>
                    <div class="p-fee__content__edit__length__time p-fee-content__length__time">以降5分単位</div>
                  </div>
                </div>
              </div>
              <div class="p-fee__content__photograph__ele__flex">
                <div class="p-fee__content__photograph__ele__FG">
                  <div class="p-fee__content__photograph__ele__F">
                    <div class="p-fee__content__photograph__logo">
                      <img src="assets/images/plan_F_logo.png" alt="planA">
                    </div>
                    <div class="p-fee__content__photograph__text">
                      <span>商品などの簡易撮影と編集</span>
                      <span>※業務用カメラ1台を含む（撮影１日）</span>
                    </div>
                    <div class="p-fee__content__photograph__amounts">
                      <div class="p-fee__content__photograph__amount"><span>30</span>万円</div>
                      <div class="p-fee__content__photograph__amount"><span>45</span>万円</div>
                      <div class="p-fee__content__photograph__amount"><span>65</span>万円</div>
                    </div>
                  </div>
                  <div class="p-fee__content__photograph__ele__G">
                    <div class="p-fee__content__photograph__logo">
                      <img src="assets/images/plan_G_logo.png" alt="planA">
                    </div>
                    <div class="p-fee__content__photograph__text">
                      <span>インタビューやイベントの撮影と編集</span>
                      <span>※業務用カメラ２台/ピンマイク２機を含む（撮影１日）</span>
                    </div>
                    <div class="p-fee__content__photograph__amounts">
                      <div class="p-fee__content__photograph__amount"><span>50</span>万円</div>
                      <div class="p-fee__content__photograph__amount"><span>65</span>万円</div>
                      <div class="p-fee__content__photograph__amount"><span>80</span>万円</div>
                    </div>
                  </div>
                </div>
                <div class="p-fee__content__photograph__ele__FG__last_amounts">
                  <div class="p-fee__content__photograph__ele__BC__last_amount">＋<span>15</span>万円</div>
                </div>
              </div>
            </div>
            <div class="p-fee__content__customize__block">
              <div class="p-fee__content__customize__ele_1 p-fee__content__ele__1">
                ...
                <div class="p-fee__content__customize__length__heading p-fee-content__length__heading">
                  <span>完成動画の総尺:個別にご設定</span>
                </div>
              </div>
              <div class="p-fee__content__photograph__ele__F">
                <div class="p-fee__content__photograph__logo">
                  <img src="assets/images/plan_H_logo.png" alt="planA">
                </div>
                <div class="p-fee__content__photograph__text">
                  <span>商品などの簡易撮影と編集</span>
                  <span>※業務用カメラ1台を含む（撮影１日）</span>
                ...
                <div class="p-fee__content__discount__body__numbers__block">
                  <div class="p-fee__content__discount__body__numbers">
                    <div class="p-fee__content__discount__body__number">
                      <span>2本目</span>
                      <span class="p-fee__content__discount__body__number__number__unit">10<span>%</span></span>
                    </div>
                    <div class="p-fee__content__discount__body__number__img">OFF</div>
                  </div>
                  <div class="p-fee__content__discount__body__numbers">
                    <div class="p-fee__content__discount__body__number">
                      <span>3本目</span>
                      <span class="p-fee__content__discount__body__number__number__unit">15<span>%</span></span>
                    </div>
                    <div class="p-fee__content__discount__body__number__img">OFF</div>
                  </div>
                  <div class="p-fee__content__discount__body__numbers">
                    <div class="p-fee__content__discount__body__number">
                      <span>4本目</span>
                      <span class="p-fee__content__discount__body__number__number__unit">20<span>%</span></span>
                    </div>
                    <div class="p-fee__content__discount__body__number__img">OFF</div>
                  </div>
                  <div class="p-fee__content__discount__body__numbers">
                    <div class="p-fee__content__discount__body__number">
                      <span>5本目以降</span>
                      <span class="p-fee__content__discount__body__number__number__unit">25<span>%</span></span>
                    </div>
                    <div class="p-fee__content__discount__body__number__img">OFF</div>
                  </div>
                </div>
          ...
          <div id="option-content" class="p-fee__optionContent p-fee__content">
            <div class="p-fee__optionContent__table">
              <div class="p-fee__optionContent__table__heading">
                <p>オプション料金</p>
              </div>
            </div>
            <div class="p-fee__optionContent__tables">
              <table class="p-fee__optionContent__table">
                ...
                <!-- === ナレーション原稿制作 === -->
                <tr class="p-fee__optionContent__tr">
                  <td class="p-fee__optionContent__td p-fee__optionContent__td__heading">ナレーション原稿制作</td>
                  <td class="p-fee__optionContent__td">
                    参考資料をご提供いただき、ヒアリングを行った上で<br>当社がナレーション原稿を制作します。
                    <span class="p-fee__optionContent__td__supplyment">※映像構成制作が必要な際は下記料金が別途追加となります。</span>
                  </td>
                  <td>500文字まで：20,000円<br><span>※以降：+5,000円 / 500文字</span></td>
                </tr>
                <!-- === 映像構成制作 === -->
                <tr class="p-fee__optionContent__tr">
                  <td class="p-fee__optionContent__td p-fee__optionContent__td__heading">映像編集制作</td>
                  <td class="p-fee__optionContent__td">
                    参考資料をご提供いただき、ヒアリングを行った上で映像編集を制作します。
                    <span class="p-fee__optionContent__td__supplyment">※ナレーション原稿制作が必要な際は上記料金が別途追加となります。</span>
                  </td>
                  <td class="p-fee__optionContent__td">1分まで：30,000円<br>※以降：+10,000円 / 30秒</td>
                </tr>
                <!-- === 映像の修正 === -->
                <tr class="p-fee__optionContent__tr">
                  <td class="p-fee__optionContent__td p-fee__optionContent__td__heading">映像の修正</td>
                  <td class="p-fee__optionContent__td">修正が大幅な場合は追加料金が発生する場合があります。</td>
                  <td class="p-fee__optionContent__td">個別お見積もり</td>
                </tr>
                <!-- === 日本語ナレーターの追加 === -->
                <tr class="p-fee__optionContent__tr">
                  <td class="p-fee__optionContent__td p-fee__optionContent__td__heading">日本語ナレーターの追加</td>
                  <td class="p-fee__optionContent__td">
                ...
                <!-- === テキストの外国語翻訳 === -->
                <tr class="p-fee__optionContent__tr">
                  <td class="p-fee__optionContent__td p-fee__optionContent__td__heading">テキストの外国語翻訳</td>
                  <td class="p-fee__optionContent__td" rowspan="2">
                    外部提携会社より翻訳・ナレーターを手配します。
                ...
                <!-- === 外国語ナレーション収録 === -->
                <tr class="p-fee__optionContent__tr">
                  <td class="p-fee__optionContent__td p-fee__optionContent__td__heading">外国語ナレーション収録</td>
                </tr>
                <!-- === ロイヤリティフリー画像 === -->
                <tr class="p-fee__optionContent__tr">
                  <td class="p-fee__optionContent__td p-fee__optionContent__td__heading">ロイヤリティフリー画像</td>
                  <td class="p-fee__optionContent__td" rowspan="3">
                    外部サービスサイトからセレクトし、手配します。
                ...
                <!-- === ロイヤリティフリー動画 === -->
                <tr class="p-fee__optionContent__tr">
                  <td class="p-fee__optionContent__td p-fee__optionContent__td__heading">ロイヤリティフリー動画</td>
                  <td class="p-fee__optionContent__td">15,000 円 /1 点</td>
                </tr>
                <!-- === ロイヤリティフリー音源 === -->
                <tr class="p-fee__optionContent__tr">
                  <td class="p-fee__optionContent__td p-fee__optionContent__td__heading">ロイヤリティフリー音源</td>
                  <td class="p-fee__optionContent__td">
                    5,000 円 /1 点
                ...
                <!-- === カラーグレーディング === -->
                <tr class="p-fee__optionContent__tr">
                  <td class="p-fee__optionContent__td p-fee__optionContent__td__heading">カラーグレーディング</td>
                  <td class="p-fee__optionContent__td">
                    映像素材を希望の色の方向性に調整し、質を高めます。
                ...
                <!-- === MA スタジオ使用料 === -->
                <tr class="p-fee__optionContent__tr">
                  <td class="p-fee__optionContent__td p-fee__optionContent__td__heading">
                    MA スタジオ使用料<br>
                    <span class="p-fee__optionContent__td__heading__supplyment">（都内近郊限定）</span>
                  </td>
                  <td class="p-fee__optionContent__td">
                ...
                <!-- === 画角変更リサイズ === -->
                <tr class="p-fee__optionContent__tr">
                  <td class="p-fee__optionContent__td p-fee__optionContent__td__heading">画角変更リサイズ</td>
                  <td class="p-fee__optionContent__td">
                ...
                <!-- === WebCM 入稿データ制作 === -->
                <tr class="p-fee__optionContent__tr">
                  <td class="p-fee__optionContent__td p-fee__optionContent__td__heading">WebCM 入稿データ制作</td>
                  <td class="p-fee__optionContent__td">
                ...
                <!-- === TVCM 用入稿データ素材制作 === -->
                <tr class="p-fee__optionContent__tr">
                  <td class="p-fee__optionContent__td p-fee__optionContent__td__heading">TVCM 用入稿データ素材制作</td>
                  <td class="p-fee__optionContent__td">
                    媒体社の媒体規定に応じて入稿素材を制作します。<br>
                ...
                <!-- === 動画内容の改訂納品 === -->
                <tr class="p-fee__optionContent__tr">
                  <td class="p-fee__optionContent__td p-fee__optionContent__td__heading">動画内容の改訂納品</td>
                  <td class="p-fee__optionContent__td">
                ...
                <!-- === サムネイル制作 === -->
                <tr class="p-fee__optionContent__tr">
                  <td class="p-fee__optionContent__td p-fee__optionContent__td__heading">サムネイル制作</td>
                  <td class="p-fee__optionContent__td">
                ...
                <!-- === グラフィック制作 === -->
                <tr class="p-fee__optionContent__tr">
                  <td class="p-fee__optionContent__td p-fee__optionContent__td__heading">グラフィック制作</td>
                  <td class="p-fee__optionContent__td">
                ...
                <!-- === Web サイト制作 === -->
                <tr class="p-fee__optionContent__tr">
                  <td class="p-fee__optionContent__td p-fee__optionContent__td__heading">Web サイト制作</td>
                  <td class="p-fee__optionContent__td">
                ...
                <!-- === 短期納品対応 === -->
                <tr class="p-fee__optionContent__tr">
                  <td class="p-fee__optionContent__td p-fee__optionContent__td__heading">短期納品対応</td>
                  <td class="p-fee__optionContent__td">
              ...
              <table class="p-fee__optionContent__table p-fee__optionContent__photograph__table">
                <tr class="p-fee__optionContent__tr">
                  ...
                  <th class="p-fee__optionContent__th">
                    費用の目安<br>
                    <span class="p-fee__optionContent__th__supplyment">※条件によって異なります</span>
                  </th>
                </tr>
                <!-- === 各種スタッフの追加 === -->
                <tr class="p-fee__optionContent__tr">
                  <td class="p-fee__optionContent__td p-fee__optionContent__td__heading">各種スタッフの追加</td>
                  <td class="p-fee__optionContent__td">
                ...
                <!-- === 各種機材の追加 === -->
                <tr class="p-fee__optionContent__tr">
                  <td class="p-fee__optionContent__td p-fee__optionContent__td__heading">各種機材の追加</td>
                  <td class="p-fee__optionContent__td">
                ...
                <!-- === 撮影スタジオ・ロケ地使用料 === -->
                <tr class="p-fee__optionContent__tr">
                  <td class="p-fee__optionContent__td p-fee__optionContent__td__heading">撮影スタジオ・ロケ地使用料</td>
                  <td class="p-fee__optionContent__td">
                ...
                <!-- === 美術・小道具の手配 === -->
                <tr class="p-fee__optionContent__tr">
                  <td class="p-fee__optionContent__td p-fee__optionContent__td__heading">美術・小道具の手配</td>
                  <td class="p-fee__optionContent__td">
                    撮影内容に応じて美術や小道具を手配します。
                    内容・希望に応じて人件費等も別途必要になります。
                  </td>
                </tr>
                <!-- === 著名人 / タレントのキャスティング === -->
                <tr class="p-fee__optionContent__tr">
                  <td class="p-fee__optionContent__td p-fee__optionContent__td__heading">著名人 / タレントの<br>キャスティング</td>
                  <td class="p-fee__optionContent__td">著名人やタレントをキャスティング会社を通して<br>発注します。</td>
                </tr>
                <!-- === 各種経費 === -->
                <tr class="p-fee__optionContent__tr">
                  <td class="p-fee__optionContent__td p-fee__optionContent__td__heading">各種経費</td>
    ...
    <!--======== p-deliver ========-->
    <section class="p-deliver l-section">
      <div class="p-deliver__container l-container">
        <div class="p-deliver__block">
          ...
          <div class="p-deliver__btns">
            <div id="edit-flow-btn" class="p-deliver__btn">
            ...
            <div id="production-flow-btn" class="p-deliver__btn">
              <div class="p-deliver__btn__img">
          ...
          <!-- === 「編集のみ」制作の流れの納品フロー === -->
          <div id="edit-flow" class="p-deliver__flow p-deliver__editOnly__flow">
          ...
          <div id="production-flow" class="p-deliver__flow p-deliver__addProduction__flow">
            ...
            <div class="p-deliver__flow__schedules">
              <div class="p-deliver__flow__schedule">
                <div class="p-deliver__flow__schedule__heading">
                  <p>動画尺</p>
                  <span class="p-deliver__flow__schedule__heading__span__primaryColor">短</span><br>
                  <p>撮影手配</p>
            ...
            <div class="p-cancel__card__notPhotograph p-cancel__card">
              ...
              <div class="p-cancel__card__bodys">
                <div class="p-cancel__card__body">
                  ...
                  <div class="p-cancel__card__body__arrow">
                    <img src="assets/images/cancel_arrow_icon.png" alt="">
                  </div>
          ...
          <div class="p-qa__content">
            ...
            <div class="p-qa__content__list">
              ...
              <div class="p-qa__content__list__item">
                <div class="p-qa__content__list__question">
    ...
    <!--======== p-staff ========-->
    <section class="p-staff l-section">
      <div class="p-staff__container l-container">
        <div class="p-staff__block">
          ...
          <div class="p-staff__profile__president">
            <div class="p-staff__profile__president__img">
          ...
          <div class="p-staff__profile__members">
            <div class="p-staff__profile__member">
              <div class="cimg">
                <img src="assets/images/staff_hisaki_icon.png" alt="">
              </div>
            ...
            <div class="p-staff__profile__member">
              <div class="cimg">
                <img src="assets/images/staff_mossy_icon.png" alt="">
              </div>
              <div class="p-staff__profile__member__body">
            ...
            <div class="p-staff__profile__member">
              <div class="cimg">
                <img src="assets/images/staff_funa_icon.png" alt="">
              </div>
              <div class="p-staff__profile__member__body">
                <h3>ムービーエディター／デザイナー</h3>
            ...
            <div class="p-staff__profile__member">
              <div class="cimg">
                <img src="assets/images/staff_task_icon.png" alt="">
              </div>
              <div class="p-staff__profile__member__body">
            ...
            <div class="p-staff__profile__member">
              <div class="cimg">
                <img src="assets/images/staff_machiko_icon.png" alt="">
              </div>
              <div class="p-staff__profile__member__body">
                <h3>ムービーエディター</h3>
            ...
            <div class="p-staff__profile__member">
              <div class="cimg">
                <img src="assets/images/staff_narumi_icon.png" alt="">
              </div>
              <div class="p-staff__profile__member__body">
                <h3>デザイナー</h3>
            ...
            <div class="p-staff__profile__member">
              <div class="cimg">
                <img src="assets/images/staff_yukiya_icon.png" alt="">
              </div>
              <div class="p-staff__profile__member__body">
            ...
            <div class="p-staff__profile__member">
              <div class="cimg">
                <img src="assets/images/staff_tommyK_icon.png" alt="">
              </div>
              <div class="p-staff__profile__member__body">
            ...
            <div class="p-staff__profile__member">
              <div class="cimg">
                <img src="assets/images/staff_monin_icon.png" alt="">
              </div>
              <div class="p-staff__profile__member__body">
                <h3>修行僧</h3>
      ...
      <div class="p-contact__container l-container">
        <div class="p-contact__block">
          ...
          <div class="p-contact__forms">
            <!-- === とりあえず問合せや相談をしたいお客さま === -->
            <form action="" method="post" class="p-contact__form p-contact__consult__form">
              <div class="p-contact__form__inner">
                ...
                <div class="p-contact__form__arrow__img">
                ...
                <div class="p-contact__form__item">
                  ...
                  <div class="p-contact__form__item__input p-contact__form__item__select">
                    ...
                    <select name="schedule-hour-last">
                      <?php for ($i = 8; $i <= 20; $i++): ?>
                        <option value="<?php echo $i; ?>"><?php echo $i; ?>時</option>
                      <?php endfor; ?>
                    </select>
                    <select name="schedule-minutes-last">
                      <?php for ($i = 00; $i <= 59; $i++): ?>
                        <option value="<?php echo $i; ?>"><?php echo $i; ?>分</option>
                      <?php endfor; ?>
                    </select>
            ...
            <!-- === お見積もりをご希望のお客さま === -->
            <form action="" method="post" class="p-contact__form p-contact__estimate__form">
              <div class="p-contact__form__inner">
                <div class="p-contact__form__box">
                  <!-- = お名前 = -->
                  <div class="p-contact__form__item">
                  ...
                  <div class="p-contact__form__item__input p-contact__form__item__input__production">
                    <div class="p-contact__form__item__estimate__select p-contact__form__item__estimate__select__prodLength">
                      <select name="production-length-minutes">
                        <?php for ($i = 1; $i <= 59; $i++): ?>
                          <option value="<?php echo $i; ?>"><?php echo $i; ?></option>分
                        <?php endfor; ?>
                      </select>
                      <select name="production-length-seconds">
                        <?php for ($i = 00; $i <= 59; $i++): ?>
                          <option value="<?php echo $i; ?>"><?php echo $i; ?></option>秒
                        <?php endfor; ?>
                      </select>
                  ...
                  <div class="p-contact__form__item__input p-contact__form__item__input__production">
                    <div class="p-contact__form__item__estimate__select p-contact__form__item__estimate__select__prodBudget">
                      <select name="production-budget-min">
                        <?php for ($i = 1; $i <= 100; $i++): ?>
                          <option value="<?php echo $i; ?>"><?php echo $i; ?></option>円
                        <?php endfor; ?>
                      </select>
                      <div class="p-contact__form__item__select__wave">〜</div>
              ...
              <button type="submit" class="p-contact__form__submit">内容の確定</button>
            </form>
          </div>
        </div>
      </div>
    ...
    <footer class="l-footer">
      <div class="l-footer__container">
        <div class="l-footer__call">
          ...
          <div class="l-footer__call__body">
